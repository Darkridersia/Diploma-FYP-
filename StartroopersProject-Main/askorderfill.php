...
$sql = "SELECT * FROM itemhistory WHERE order_id  = $oid";
$result = mysqli_query($conn, $sql);
$products = mysqli_fetch_all($result, MYSQLI_ASSOC);
// if the user is view from purcahsed history, then the email will send to seller
if($v == "purchased"){
...
endforeach;
   ...
   // if the user is view from purcahsed history, then the email will send to buyer
    foreach ($products as $product):
      ...
      <div class="screen">
        ...
        <div class="screen-body">
          <div class="screen-body-item left">
            ...
            <?php if($v == 'purchased') { ?>
                <!-- if the user is view from purcahsed history, then contact seller -->
              <span>CONTACT SELLER</span>
              <?php } else { ?>
 <!-- if the user is view from purcahsed history, then contact buyer -->
          ...
          <div class="screen-body-item">
            <div class="app-form">
              ...
              <form action="Php/askorder.php" method="POST">
              <input class="app-form-control" placeholder="Email" type="hidden" name="view" value="<?php echo $_GET['view'] ?>" required>
                ...
                <div class="app-form-group">
                  <textarea class="app-form-control" placeholder="Ask anything..." name="message" id="message" cols="20" rows="2" required></textarea>
                </div>
                ...
                <div class="app-form-group">
                  ...
                  <input class="app-form-control" type="text" name="order_id" value="<?php echo $oid ?>" readonly>
                  <input class="app-form-control" type="hidden" name="batchid" value="<?php echo $bid ?>" readonly>
                </div>
