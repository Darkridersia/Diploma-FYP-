      ...
      <div class="screen">
        ...
        <div class="screen-body">
          <div class="screen-body-item left">
            ...
            <div class="app-contact">E-Mail: <br> StarTroopers@gmail.com</div>
            <div class="app-contact">Contact No: <br> +6016 888 3388</div>
          </div>
            ...
            <div class="app-form">
              <form action="Php/contactus.php" method="POST">
                <div class="app-form-group">
                  <input class="app-form-control" placeholder="NAME" type="text" name="name" id="name"><!--Enter your name here-->
                </div>

                <div class="app-form-group">
                  <input class="app-form-control" placeholder="Email" type="email" name="email"><!--Enter your email here-->
                </div>

                <div class="app-form-group">
                  <textarea class="app-form-control " placeholder="MESSAGE" name="message" id="message" cols="20" rows="2"></textarea><!--Enter your message here-->
                </div>
