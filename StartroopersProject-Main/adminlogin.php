      ...
      <div class="screen">
        ...
        <div class="screen-body">
          <div class="screen-body-item left">
            ...
            <div>
              <form action="adminlogin.php" id="adminserver-form" method="post">

                <div class="screen-body-item">
                  <div class="app-form">
                    <div class="app-form-group">
                      <input class="app-form-control" PLACEHOLDER="Admin Email" id="user_email" type="text" name="user_email" required>
                    </div>
                    ...
                    <div class="app-form-group buttons">
                      <a href="register.php?page=admin" class="btn btn-primary" style="float:left; margin-top: -20%;">Register</a>
                    </div>
                    <div>
                      <p><a href="change_password(type_email).php?page=admin">Forgot_password</a></p>
                    </div>
                  </div>
                </div>
            </div>
